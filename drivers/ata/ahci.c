...
static const struct ata_port_info ahci_port_info[] = {
	...
	[board_ahci_43bit_dma_no_ncq] = {
		AHCI_HFLAGS	(AHCI_HFLAG_43BIT_ONLY | AHCI_HFLAG_NO_NCQ),
		.flags		= AHCI_FLAG_COMMON,
		.pio_mask	= ATA_PIO4,
		.udma_mask	= ATA_UDMA6,
		.port_ops	= &ahci_ops,
...
static const struct pci_device_id ahci_pci_tbl[] = {
	...
	/* ASMedia */
	{ PCI_VDEVICE(ASMEDIA, 0x0601), board_ahci_43bit_dma_no_ncq },	/* ASM1060 */
	{ PCI_VDEVICE(ASMEDIA, 0x0602), board_ahci_43bit_dma_no_ncq },	/* ASM1060 */
	{ PCI_VDEVICE(ASMEDIA, 0x0611), board_ahci_43bit_dma_no_ncq },	/* ASM1061 */
	{ PCI_VDEVICE(ASMEDIA, 0x0612), board_ahci_43bit_dma_no_ncq },	/* ASM1061/1062 */
	{ PCI_VDEVICE(ASMEDIA, 0x0621), board_ahci_43bit_dma_no_ncq },	/* ASM1061R */
	{ PCI_VDEVICE(ASMEDIA, 0x0622), board_ahci_43bit_dma_no_ncq },	/* ASM1062R */
	{ PCI_VDEVICE(ASMEDIA, 0x0624), board_ahci_43bit_dma_no_ncq },	/* ASM1062+JMB575 */
	{ PCI_VDEVICE(ASMEDIA, 0x1062), board_ahci_no_ncq },	/* ASM1062A */
	{ PCI_VDEVICE(ASMEDIA, 0x1064), board_ahci_no_ncq },	/* ASM1064 */
	{ PCI_VDEVICE(ASMEDIA, 0x1164), board_ahci_no_ncq },   /* ASM1164 */
	{ PCI_VDEVICE(ASMEDIA, 0x1165), board_ahci_no_ncq },   /* ASM1165 */
	{ PCI_VDEVICE(ASMEDIA, 0x1166), board_ahci_no_ncq },   /* ASM1166 */
